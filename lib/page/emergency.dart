        ...
        body: Stepper(
          ...
          steps: <Step>[
            ...
            Step(
              ...
              content: Text('傷病者に近づき、反応（意識）を確認してください。コロナ禍においては、感染症対策のため、傷病者の顔と救助者の顔があまり近づきすぎないようにしてください。', style: TextStyle(fontSize: 24)),
              isActive: _index >= 1,
            ),
            Step(
              title:  _index == 2 ? Text('大声で叫び応援を求む',
                 style: TextStyle(color: Colors.blue, fontSize: 36)) : Text('大声で叫び応援を求む'),
              content: Text('傷病者に反応がなければ、大声で叫び応援を呼んでください。', style: TextStyle(fontSize: 24)),
              isActive: _index >= 2,
            ),
            Step(
              ...
              content: Text('胸と腹部の動きを見て、息があるか確認。10秒以内で確認してください。呼吸がないか、普段どおりではない場合（死戦期呼吸：しゃくりあげるように途切れ途切れの呼吸）は、心停止と判断してください。また、「普段どおりの呼吸」かどうか分からない場合も、胸骨圧迫を開始してください。', style: TextStyle(fontSize: 24)),
              isActive: _index >= 4,
            ),
            Step(
              title: _index == 5 ? Text('胸骨圧迫', style: TextStyle(color: Colors.blue, fontSize: 36)) : Text('胸骨圧迫'),
              content: Text('呼吸がない、異常な呼吸（しゃくりあげるような不規則な呼吸）がある場合は直ちに行ってください。胸の真ん中付近で心臓マッサージを行ってください。コロナ禍においては、感染症対策のため、胸骨圧迫を開始する前に、ハンカチやタオルなどがあれば傷病者の鼻と口にそれをかぶせるようにしてください（マスクや衣服などで代用しても構いません）。', style: TextStyle(fontSize: 24)),
              isActive: _index >= 5,
            )
          ],
        ));
